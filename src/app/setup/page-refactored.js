...
import { ProjectMappingRefactored } from '@/components/setup/ProjectMappingRefactored';
...
export default function SetupPageRefactored() {
  ...
  const loadDefaultConfig = useCallback(async () => {
    try {
      ...
      logger.error('Error loading default config:', error);
    }
  }, [loadConfigFromSaved]);
  ...
  const handleCreateNew = () => {
    // Reset to a clean, empty configuration
    resetConfig();
